...
- **Hub lock.** On a site without a password, choose `Set password`. Dialog `#pw-dlg` title about password. Generate or type a phrase, choose `Save`. Catalog row shows a lock badge. Public GET without header is 401.
