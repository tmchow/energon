...
describe("signed-in pages", () => {
  it("hub HTML renders and its JS only binds existing elements", async () => {
    ...
    expect(html).toContain("Ship a file or a site in seconds.");
  ...
  it("setup and tokens are signed-in pages with working element bindings", async () => {
    ...
    expect(setupHtml).toContain("Let the host guide the install");
  ...
  it("about and stats are signed-in pages with you vs system counts", async () => {
    ...
    expect(aboutHtml).toContain("Links are always public");
    expect(aboutHtml).toContain("Ship a prototype");
    expect(aboutHtml).toContain("Last write wins");
    expect(aboutHtml).toContain("Google Docs");
    expect(aboutHtml).toContain("Google Drive");
    ...
    expect(aboutHtml).toContain("not solved without Energon");
    expect(aboutHtml).toContain("Nothing does both");
