...
Tile stroke: quiet (fg 14%), hairline (fg 22%), or brand violet. Framing only the lockup leaves people larger; matching tiles on both slots is the proposed fix. Recommend hairline 22%.
