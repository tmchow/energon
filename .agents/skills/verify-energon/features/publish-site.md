...
- `site-mermaid` renders mermaid fences on HTML markdown views from `/static/mermaid/mermaid.esm.min.mjs` (no jsDelivr) and loads `/static/md-expand.mjs` for the preview overlay.
- `site-md-table` loads `/static/md-expand.mjs` on HTML markdown that contains a table, without the mermaid ESM.
