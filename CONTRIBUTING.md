...
4. Fill [`.github/PULL_REQUEST_TEMPLATE.md`](./.github/PULL_REQUEST_TEMPLATE.md). Keep the headings. Agents: do not delete sections or replace the body with a commit dump. Agent-authored PRs are fine; someone must still be able to answer review questions.
