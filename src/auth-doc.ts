...
2. Keep \`poll_token\` private in memory. It only permits retrieving the result of this request; it cannot access files. Show the human \`verification_uri\` and \`user_code\`. Ask them to open the link, sign in, enter the code, choose a token lifetime, and approve. Do not automate the human's approval or ask for their sign-in credentials.
