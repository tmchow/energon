...
- [Admin](${origin}/admin): operators listed on \`ADMIN_EMAILS\`. Retire old work and list or revoke tokens across accounts; every action is recorded. Signed-in humans only.
